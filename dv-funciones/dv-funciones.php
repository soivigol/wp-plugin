...
function custom_scripts() {
	...
	wp_register_script( 'dv-custom-js', plugin_dir_url(__FILE__) .'js/custom.js', array( 'jquery' ), '1.0', true );
...
function custom_styles() {
	...
	wp_register_style( 'dv-custom-style', plugin_dir_url(__FILE__) .'css/custom.css', false, '1.0' );
